...
; fÅr 1280x960 Hochformat (150dpi)
init:
		dc.b		27,'*t150R'
		dc.b		27,'*r1280S'
		dc.b		27,'*b0M'
...
ENDIF
		dc.b		13,10
		dc.b		'+-----------------------------+',13,10
		dc.b		'| TT-High DeskCopy installed! |',13,10
		dc.b		'+-----------------------------+',13,10
		dc.b		'| (c) Stephan Slabihoud 1996  |',13,10
		dc.b		'+-----------------------------+',13,10
		dc.b		'| Version 1.0      20.01.1996 |',13,10
		dc.b		'+-----------------------------+',13,10
		dc.b		13,10,0
text_2:
		dc.b		13,10
		dc.b		' TT-High DeskCopy already installed! ',13,10
		dc.b		13,10,0
text_1:
		dc.b		13,10
		dc.b		' TT-High DeskCopy needs VBL slot #7! ',13,10
		dc.b		13,10,0
