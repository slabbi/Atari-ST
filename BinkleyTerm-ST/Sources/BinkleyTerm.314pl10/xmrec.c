...
STATES Xmodem_Receiver[] = {
   ...
   { "XREnd", ( void *) XREnd },
   { "XR0",  ( void *)XRRecInit },
   { "XR0B", ( void *)XRBrecInit },
   { "XR1",  ( void *)XRRecStart },
   { "XR2",  ( void *)XRWaitFirst },
   { "XR3",  ( void *)XRWaitBlock },
   { "XR4",  ( void *)XRRestart },
   { "XR5",  ( void *)XRSetOvrdr }
};
...
STATES ACK_States[] = {
   { "SAInit", ( void *) SAInit },
   { "SAEnd", ( void *) SAEnd },
   { "SA0", ( void *) SAClearLine },
   { "SA1", ( void *) SASendACK },
   { "SA2", ( void *) SASEAlink },
   { "SA3", ( void *) SAIncBlk }
};

int cdecl SAInit( XMARGSP args, int start_state)
{
   if ( args )
   {
   }
...
int cdecl SAEnd( XMARGSP args, int cur_state )
{
   if ( args )
   {
   }
...
STATES NAK_States[] = {
   { "SNInit", ( void *) SNInit },
   { "SNEnd", ( void *) SNEnd },
   { "SN0", ( void *) SNClearLine },
   { "SN1", ( void *) SNSendNAK },
   { "SN2", ( void *) SNSEAlink },
   { "SN3", ( void *) SNAckResync }
};

int cdecl SNInit( XMARGSP args, int start_state )
{
   if ( args )
   {
   }
...
int cdecl SNEnd( XMARGSP args, int cur_state )
{
   if ( args )
   {
   }
