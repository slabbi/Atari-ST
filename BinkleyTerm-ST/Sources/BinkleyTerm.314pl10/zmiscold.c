...
/*	 register int time_val = 0; */
   ...
   timeout = timerset ((long)tenths * 10);	/* was 30 */

/*    status_line ("!Test 1 in get byte");
    status_line ("!Peekbyte is %d", PEEKBYTE);
    status_line ("!Modemin is %d", MODEM_IN);
*/
...
/*     status_line ("!Test 3 in get byte");
      status_line ("!Peekbyte is %d", PEEKBYTE);
      status_line ("!Modemin is %d", MODEM_IN);
*/
   ...
   status_line ("!Timeout in Getbyte");
   return TIMEOUT;
}
