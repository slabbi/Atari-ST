...
; 1.12 - Interrups disabled (faster)
; 1.13 - Peekbyte changed (faster)
; 1.14 - Peekbyte (IMHO) corrected
; 1.14x- Only for ST_ESCC
...
SCCA_CNT	EQU		0xFFFFFA35
SCCB_CNT	EQU		0xFFFFFA31
...
init:	dc.b	13,10
			dc.b	' ~~~~~~~~~~~~~~~~~~-~~~~~~~~~~~~~~~~~~~~~~~~~ ',13,10
			dc.b	' | External Binkley-IO-Driver V1.14 ST_ESCC | ',13,10
			dc.b	' | (c) St.Slabihoud 1993,1994,1995,1996     | ',13,10
			dc.b	' ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ',13,10,0
...
peekbyte:
		...
		move.w	6(a0),d0		/* if( iorec->ibufhd!=iorec->ibuftl ) */
		cmp.w		8(a0),d0
		bne.s		peek2
		moveq		#-1,d0
		rts
